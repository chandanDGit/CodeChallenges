...
public class UpdateBuyCommand implements TransactionCommand {
	...
	public UpdateBuyCommand(String[] commandArr) {
	...
	public void validateCommand() throws StoreException {
		...
		transaction.setTransactionType(Constants._updateBuy);
	...
	public void saveTransaction() throws StoreException {
		...
		transaction.setTotalTransactionValue(
				Utility.convertToTwoDecimal(transaction.getQuantity() * product.getBuyingPrice()));
